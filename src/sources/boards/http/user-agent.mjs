...
export const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; huntley/1.0; +https://github.com/victorjaml/huntley)';

/**
 * Browser-like User-Agent for callers that must clear WAF/CDN bot management
 * blocking the plain huntley UA outright (seen live: Glints' firewall,
